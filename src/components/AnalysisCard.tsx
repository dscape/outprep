...
/* FullEvalBar imported from analysis-shared.tsx */
...
/* MoveButton imported from analysis-shared.tsx */
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-shrink-0">
            <div className="flex gap-2 mx-auto lg:mx-0" style={{ width: "fit-content" }}>
              <FullEvalBar evalCp={currentEval} orientation={analysis.playerColor} />
