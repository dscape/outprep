/**
 * Adapters converting Lichess types to engine-agnostic types.
 * Adapted from src/lib/lichess-adapters.ts.
 */
...
import type { LichessGame, LichessEvalAnnotation } from "./lichess-types";
